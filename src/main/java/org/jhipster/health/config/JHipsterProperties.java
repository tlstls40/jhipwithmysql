...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipwithmysql@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipwithmysql API";

        private String description = "jhipwithmysql API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipwithmysql";
